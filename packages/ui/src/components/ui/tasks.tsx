export function Task({incompleteonclick,inprogressonclick,completeonclick,taskDetail}:any){
    ...
    if(taskDetail.taskStatus=="incomplete"){
        return <div className="bg-white border border-black p-4 m-1 rounded-md shadow-md">
        ...
        <div className="flex justify-between ">
         ...
         hover:bg-blue-200">Incomplete</button> */}
            <button onClick={inprogressonclick} className="bg-white border border-black m-1 p-1 w-full  rounded-md active:bg-slate-400
         hover:bg-blue-200">Start</button>
            <button  onClick={completeonclick} className="bg-white border border-black p-1 m-1 rounded-md active:bg-slate-400
        ...
        <div className="text-zinc-400 select-none">Status:{taskDetail.taskStatus}</div>
        <div className="flex justify-between">
            <button onClick={incompleteonclick} className="bg-white border border-black p-1 w-full m-1 rounded-md active:bg-slate-400
        ...
        <div className="text-zinc-400 select-none">Status:{taskDetail.taskStatus}</div>
        <div className="flex justify-between">
            <button onClick={incompleteonclick} className="bg-white border border-black p-1 m-1 w-full rounded-md active:bg-slate-400
         hover:bg-blue-200">Stop</button>
            <button onClick={inprogressonclick} className="bg-white border border-black p-1  m-1 w-full rounded-md active:bg-slate-400
         hover:bg-blue-200">Start</button>
